...
import argparse
import wandb
wandb.init(project="robert_mosi_mynet_50_16_model_mae_new",name='robert_wandb_233333_all_param')
...
from my_model import Roberta, WEIGHTS_NAME, CONFIG_NAME,length_mask,Roberta_transformer_herical,convert_linear_layer_to_lora,only_optimize_lora_parameters
...
path_train='/qingzhong/paper/data/mosi/train.pkl'
path_dev='/qingzhong/paper/data/mosi/dev.pkl'
path_test='/qingzhong/paper/data/mosi/test.pkl'
# 单GPU
...
def main(i):
    ...
    parser.add_argument("--data_dir", default='/qingzhong/paper/data/mosi', type=str,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--bert_model", default=path_model, type=str,
    ...
    tokenizer=RobertaTokenizer.from_pretrained(path_model,do_lower_case=args.do_lower_case)
    #tokenizer=BertTokenizer.from_pretrained(path_model,do_lower_case=args.do_lower_case)
    train_examples = None
    ...
    model=Roberta_transformer_herical(output_size=768,audio_size=47,vision_size=74)
