...
def main(i):
    ...
    parser.add_argument("--output_dir",
                        default='D:\\A_L_V\\result', type=str,
    ...
    train_audio,train_audio_length=A_V_data(path_train,maxlen=50,mode='vision')
    train_audio=torch.tensor(train_audio)
    valid_audio,v_length=A_V_data(path_dev,maxlen=50,mode='vision')
    valid_audio=torch.tensor(valid_audio)
    test_audio,test_length=A_V_data(path_test,maxlen=50,mode='vision')
