...
wandb.init(project="robert_mosi_mynet_50_16_model_daa", name='robert_wandb_50_16_2')
...
from my_model import Roberta_daa, WEIGHTS_NAME, CONFIG_NAME, length_mask
...
def main(i):
    ...
    parser.add_argument("--data_dir",
                        default='D:\\cmudata\\CMU-MultimodalSDK-master\\examples\\mmdatasdk_examples\\full_examples\\cmumosi\\',
                        type=str,
    ...
    ##############################################################################################################
    model = Roberta_daa(output_size=100, audio_size=47, vision_size=74)
