...
wandb.init(project="robert_mosi_mynet_50_16_model_nonal", name='robert_wandb_50_16_2')
...
path_train = 'D:\\cmudata\\CMU-MultimodalSDK-master\\examples\\mmdatasdk_examples\\full_examples\\cmumosi\\unalinge\\train.pkl'
path_dev = 'D:\\cmudata\\CMU-MultimodalSDK-master\\examples\\mmdatasdk_examples\\full_examples\cmumosi\\unalinge\\dev.pkl'
path_test = 'D:\\cmudata\\CMU-MultimodalSDK-master\\examples\\mmdatasdk_examples\\full_examples\\cmumosi\\unalinge\\test.pkl'
# 单GPU
...
def main(i):
    ...
    parser.add_argument("--data_dir",
                        default='D:\\cmudata\\CMU-MultimodalSDK-master\\examples\\mmdatasdk_examples\\full_examples\\cmumosi\\unalinge\\',
                        type=str,
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            with tqdm(train_dataloader, desc="Iteration") as tepoch:
                for step, batch in enumerate(tepoch):
                    ...
                    loss, logits = model(input_ids, all_train_audio, all_train_vision, segment_ids, input_mask,
                                         label_ids)
                    if n_gpu > 1:
